...
class CitationTest(unittest.TestCase):
    ...
    def test_title_when_link_and_article_citation(self):
        """
        Test the method citation.title() when link and article citation.

        Its must return one of them
        """
        json_citation = {}
        ...
        self.assertIn(citation.title(), [u'It is the journal title',
                                         u'It is the link title'])

    def test_title_when_thesis_and_article_citation(self):
        """
        Test the method citation.title() when thesis and article citation.
        ...
        self.assertIn(citation.title(), [u'It is the thesis title',
                                         u'It is a article title'])
